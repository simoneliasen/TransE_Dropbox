...
f = open('../data/FB15k237_entity2idx.pkl', 'w')
g = open('../data/FB15k237_idx2entity.pkl', 'w')
...
for datatyp in ['train', 'valid', 'test']:
    ...
    if 'data' not in os.listdir('../'):
        os.mkdir('../data')
    f = open('../data/FB15k237-%s-lhs.pkl' % datatyp, 'w')
    g = open('../data/FB15k237-%s-rhs.pkl' % datatyp, 'w')
    h = open('../data/FB15k237-%s-rel.pkl' % datatyp, 'w')
