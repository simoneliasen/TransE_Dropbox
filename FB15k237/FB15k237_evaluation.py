...
def RankingEval(datapath='../data/', dataset='FB15k237-test',
        loadmodel='best_valid_model.pkl', neval='all', Nsyn=14778, n=10,
        idx2synsetfile='FB15k237_idx2entity.pkl'):
...
def RankingEvalFil(datapath='../data/', dataset='FB15k237', op='TransE',
        loadmodel='best_valid_model.pkl', fold=0, Nrel=237, Nsyn=14778):
